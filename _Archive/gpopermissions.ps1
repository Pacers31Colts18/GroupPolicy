...
{
if ($name.tolower().startswith("iu-iusm"))
{
$stackGpo.Push($name)
echo $name
Set-GPPermission -Name $name -PermissionLevel GpoEditDeleteModifySecurity -TargetName iu-cait-admins-activedirectory -TargetType group > $null
}
if ($name.tolower().startswith("iu-cait"))
{
$stackGpo.Push($name)
echo $name
Set-GPPermission -Name $name -PermissionLevel GpoEditDeleteModifySecurity -TargetName iu-cait-admins-activedirectory -TargetType group > $null
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMDl91sr70831mXUAwl7Hmztm
# cN+gggtfMIIFbDCCBFSgAwIBAgIQNfbEOOj3ehF5nQxYwH0kXTANBgkqhkiG9w0B
...
# AgEVMCMGCSqGSIb3DQEJBDEWBBRGhwh0yw12UmuaYSx7fMxeIijBpjANBgkqhkiG
# 9w0BAQEFAASCAQCPhkxRF6mWQhfT1b9pRnnJnHsMgXDJ3ofeG0yRjz1T1ryWvWux
# 0YtkDb25mb7dRTLhUcHxnSt9C0bkwOduRxg5bF/rEZcyztZLHfmIvJqAvepYnsEz
# zSqlXrpj5NQik5OltKJU7VdrtsEZs6GmHMSiT5tCqiNfZDPv9O/p4PP06QK0CONE
# HRoR1jGfdyc1jy4z0fO2c+RWHrM+FINGOcAApqYqOyi8CycH6s3z3YX7WMf579X6
# YQbaE9CBVfOdk1HzKmn7WaLWWERfTjLi7fKas3BPr0sgx7ru+7q4zSdSlIuOqrn4
# d8uXPmcW0Pd1AnqyXDFscNeE1sg/nCuWjdqy
